...
public class StudentService {
    ...
    public void delete(String uid) throws Exception {
        ...
        DBFactory.getStudentDB().delete(student);
    }
    ...
    public void unsubscribeStudent(String uid, String id) throws Exception {
        // get student 
        Student studentUnsubscribing= getRegisteredStudent(uid) ;

        // get subscribed student 
        Student studentUnsubscribed = getRegisteredStudent(id) ;

        
        studentUnsubscribing.getSubscribedStudent().remove(studentUnsubscribed.getUid());

        studentUnsubscribed.getSubscribedStudent().remove(studentUnsubscribing.getUid());

        //update student in database
        DBFactory.getStudentDB().update(studentUnsubscribing ,studentUnsubscribed);
